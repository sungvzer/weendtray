...
public class HomePageController implements Observer<Wallet> {
    ...
    public void initialize() {
        ...
        initializeTab(usersTab, "/it/garganovolpe/weendtray/UsersTab.fxml");
        initializeTab(userDashboardTab, "/it/garganovolpe/weendtray/UserDashboard.fxml");
        initializeTab(topUpTab, "/it/garganovolpe/weendtray/TopUp.fxml");
        initializeTab(internetTab, "/it/garganovolpe/weendtray/InternetTab.fxml");
        initializeTab(messagesTab, "/it/garganovolpe/weendtray/MessagesTab.fxml");
        initializeTab(callTab, "/it/garganovolpe/weendtray/CallTab.fxml");
    }
    ...
    public void onLogout() {
        ...
        URL url = getClass().getResource("/it/garganovolpe/weendtray/LoginPage.fxml");
